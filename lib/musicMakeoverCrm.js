...
const DEFAULT_SITE_CONTENT = {
  home: {
    heroHeadline: 'Music coaching for confident singers, stronger teams, and thriving programs.',
    heroBody: 'The Music Makeover provides personalized music coaching, worship team development, choir training, and program consulting designed to help individuals and organizations grow with confidence, excellence, and purpose.',
  ...
  services: {
    ...
    consultationBody: 'For individuals, churches, schools, and leaders who need clarity before choosing a package. We will discuss your current needs, goals, challenges, and the best next step for meaningful growth.',
  ...
  about: {
    ...
    meetParagraph1: 'Ashley Miller has nearly 20 years of experience helping singers, students, choirs, worship teams, and music programs grow with excellence and purpose.',
  ...
  contact: {
    ...
    heroBody: 'Have a question about private coaching, worship team support, choir development, workshops, or program consulting? Send a message and Ashley will follow up with the next best step.',
    ...
    instagramUrl: 'https://www.instagram.com/lambchop0328/',
    facebookUrl: 'https://www.facebook.com/profile.php?id=48004649',
  ...
  testimonials: {
    ...
    heroHeadline: "Voices we've helped",
    ...
    ctaBody: 'Whether you are seeking private coaching, choir support, worship team development, or program strategy, The Music Makeover is designed to meet you where you are and help you move forward with clarity, confidence, and purpose.',
    ctaLabel: 'Find My Next Step',
    ctaHref: 'booking.html',
  },
  booking: {
    ...
    introLine1: 'Whether you are looking for private coaching, worship team support, choir development, or a full music program intensive, this is the place to start.',
    ...
    helpBody: 'Email themusicmakeover@gmail.com with your preferred timeline and service lane.',
  },
};
