...
const FORM_FIELDS = {
  school: [
    ...
    ['supportNeeded', 'Which service are you interested in?', 'textarea'],
    ['currentChallenges', 'Current challenges', 'textarea'],
    ...
    ['budgetRange', 'Budget range', 'select'],
  ...
  ensemble: [
    ...
    ['email', 'Email', 'email'],
    ['phone', 'Phone', 'tel'],
    ['organization', 'Choir / ensemble name', 'text'],
    ['role', 'Role/title', 'text'],
    ['location', 'Location', 'text'],
  ...
  worship: [
    ...
    ['supportNeeded', 'Which service are you interested in?', 'textarea'],
    ['currentChallenges', 'Current challenges', 'textarea'],
    ['upcomingDates', 'Upcoming service/event/worship night', 'text'],
    ['preferredTimeline', 'Preferred timeline', 'text'],
    ['budgetRange', 'Budget range', 'select'],
    ['notes', 'Notes', 'textarea'],
  ],
  private: [
    ...
    ['email', 'Email', 'email'],
    ['phone', 'Phone', 'tel'],
    ['musicGoals', 'What are your current music goals?', 'textarea'],
  ...
  general: [
    ...
    ['audienceType', 'Who is this support for?', 'select'],
    ['musicGoals', 'What are your current music goals?', 'textarea'],
    ['currentChallenges', 'What challenges are you currently facing?', 'textarea'],
    ['improvementGoals', 'What would you love to see improve?', 'textarea'],
    ['upcomingDates', 'Are you preparing for an audition, event, service, performance, concert, or season?', 'text'],
    ['preferredTimeline', 'What timeline are you hoping for?', 'text'],
    ['coachingCadence', 'Are you interested in one-time support or ongoing coaching?', 'select'],
    ['preferredFormat', 'Do you prefer in-person, virtual, or either?', 'select'],
    ['howSoon', 'How soon would you like to begin?', 'text'],
    ['budgetRange', 'Budget range', 'select'],
    ['notes', 'Is there anything else I should know?', 'textarea'],
  ],
};
